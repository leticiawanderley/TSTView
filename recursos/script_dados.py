...
lista_alunos_unsorted = urllib2.urlopen(
    "https://dl.dropbox.com/u/74287933/2012.2/alunos.csv")
...
def gera_dados_alunos():
    ...
    for linha in lista_alunos_unsorted:
        ...
        corrigido = [linha[2], linha[0], linha[1], nome_corrigido.strip(
            "\n"), linha[4].strip("\n") + "@ccc.ufcg.edu.br\n"]
...
def get_resultados():
    ...
    arquivo = urllib2.urlopen(
        "https://dl.dropbox.com/u/74287933/2012.2/reports/tst-results.dat")
